Here is the complete, updated PROJECT_CONTEXT.md text with the latest progress and decisions appended, followed immediately by the first two Python files for the backend.

You can copy the context directly into your PROJECT_CONTEXT.md file, and then create the backend/ folder and drop the two Python files in there.

1. Updated Context File
   Markdown
